...
const TEXT_DESCRIPTION = 'Ngôn ngữ văn bản phải khớp với ngôn ngữ giọng nói đã chọn: Ngôn ngữ trộn (văn bản tiếng Anh với giọng nam Tây Ban Nha) không tạo ra kết quả hợp lệ. Âm thanh tổng hợp được truyền trực tuyến đến máy khách khi nó đang được sản xuất, sử dụng mã hóa phân đoạn HTTP. Âm thanh được trả lại ở định dạng mp3 có thể được phát bằng trình phát VLC và Audacity.';
      ...
      <section className="_container _container_large"> 
        <div className="row">
          <h2 className="base--h2 title">
            Nhập Dữ Liệu Đúng Với Ngôn Ngữ
          </h2>
...
Để có độ tự nhiên tối ưu, hãy chọn giọng thần kinh (V3, tăng cường dnn) trong danh sách bên dưới.
  <br/>Vui lòng xem&nbsp;
